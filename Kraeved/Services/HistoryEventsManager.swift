...
protocol HistoryEventsManagerProtocol: AnyObject {
    func getHistoryEvents(completion: @escaping ([HistoryEvent]) -> Void)
}

class HistoryEventsManager: HistoryEventsManagerProtocol {
    
    static let shared = HistoryEventsManager()
